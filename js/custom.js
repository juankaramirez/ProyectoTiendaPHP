...
$('#catEditar').click(
        function (){
            ...
            html += "<input type='submit' class='btn btn-primary' name='editar' value='Editar'></form></div></div></div>";
...
$('#catEliminar').click(
        function() {
            ...
            html += "<input type='submit' class='btn btn-primary' name='eliminar' value='Eliminar'></form></div></div></div>";
...
$('#prodEditar').click(
        function (){
            ...
            var html = "";
            html += "<div class='container'><div class='row'><div class='col-md-10'>";
            html += "<form role='form' action='productos.php' method='POST'><div class='row'><div class='col-md-3'><div class='form-group'>";
            ...
            html += "<div class='col-md-6'><div class='form-group'><label for='existenciasProd'>Existencias</label>";
            html += "<input name='existencias' type='text' class='form-control' id='existenciaProd' placeholder='Existencias'></div></div></div>";
            html += "<input name='editar' type='submit' class='btn btn-primary' value='Editar'></form></div></div></div>";
