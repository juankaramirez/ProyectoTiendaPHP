...
<html>
    ...
    <body>
        ...
        <div class="uk-grid">
            ...
            <div class="uk-push-1-10 uk-width-6-10 uk-container-center" id="principalc">
                <?php
                foreach ($dbadmin->obtenerProductosCanasta($_SESSION['user']) as $value) {
            ...
            <div class="uk-push-1-10 uk-width-3-10" name="opciones" id ='opciones'>

                <div class="uk-panel uk-panel-box uk-panel-header">
                    <h3 class="uk-panel-title">Opciones</h3>
                    <ul class="uk-nav">
                        <li>
                            <form role='form' action='canasta.php' method='POST'>
                                <div class="form-inline">
                                    <button class='uk-button uk-button-primary uk-button-expand'  type='submit' name='comprar'>Comprar</button>
                                </div>
                            </form>
                        </li>
                        <li>
                            <form role='form' action='canasta.php' method='POST'>
                                <div class="form-inline">
                                    <button class='uk-button uk-button-danger uk-button-expand'  type='submit' name='reset' id='reset1'>Reset  </button>
                                </div>
                            </form>
                        </li>
                ...
                <div class="uk-width-medium-8-10 uk-container-center">
                    <div class="uk-grid">
                        ...
                        <div class="uk-width-1-1" align="center">
                            <?php
                            if (sizeof($dbadmin->obtenerProductosCanasta($_SESSION['user'])) > 0) {
                                echo "<h2>Aún hay elementos en la canasta!</h2>";
                            } else {

                                echo "<h3>Est&aacute; seguro?</h3>";
                            }
                            ?>
                            <hr class="uk-grid-divider">
                        </div>
